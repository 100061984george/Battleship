...
static class DeploymentController
{
	...
	public static void DrawDeployment()
	{
		...
		if (_currentDirection == Direction.LeftRight) {
			SwinGame.DrawBitmap("LeftRightButton", LEFT_RIGHT_BUTTON_LEFT, TOP_BUTTONS_TOP);
			...
			SwinGame.DrawBitmap("UpDownButton", LEFT_RIGHT_BUTTON_LEFT, TOP_BUTTONS_TOP);
	...
	private static ShipName GetShipMouseIsOver()
	{
		...
		foreach (ShipName sn in Enum.GetValues(typeof(ShipName))) {
			...
			if (SwinGame.PointInRect(pt, SHIPS_LEFT, SHIPS_TOP + i * SHIPS_HEIGHT, SHIPS_WIDTH, SHIPS_HEIGHT)) {
				return sn;
			}
		}
